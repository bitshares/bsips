...
|Reporting on Condition Evaluation Outcome|Whichever off-chain entity is responsible for performing the evaluation must signal the outcome of the evaluation on the blockchain in order for the blockchain to resolve the contract under a positive evaluation.|
