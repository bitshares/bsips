...
Additionally, the following stateful checks will be applied during evwluation:
 ...
 - If `delta_amount_to_sell` is not null and negative, check it does mot exceed order's balance
