...
5. When executing, the funds in the vesting balances are shifted according to the deltas
...
- the owner and the fee paying account also directly hold the contained asset (black- and whitelist check)
